...
// "win32", "sdl" and "sdl2" only.
    ...
    (BX_WITH_WIN32 || BX_WITH_SDL || BX_WITH_SDL2)
...
#error                                                                         \
    "Handler-chaining-speedups are not supported together with internal debugger or gdb-stub!"
#endif
...
// On gcc2.95+ x86 only
#if BX_FAST_FUNC_CALL && defined(__i386__) && defined(__GNUC__) &&             \
...
#define BX_SUPPORT_PCIUSB                                                      \
  (BX_SUPPORT_USB_UHCI || BX_SUPPORT_USB_OHCI || BX_SUPPORT_USB_EHCI ||        \
   BX_SUPPORT_USB_XHCI)
...
#error                                                                         \
    "gcc 4.0.0 is known to produce incorrect code which breaks Bochs emulation"
#endif
